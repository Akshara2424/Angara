...
def render(project_id, project_name, milestones_df):
    ...
    with col_hero:
        ...
        with col_create:
            ...
            if st.button("Create First Project", key="dashboard_first_proj", use_container_width=True, type="primary"):
            ...
            if st.session_state.get("show_create_modal"):
                ...
                with st.form("new_project_form_hero", clear_on_submit=True):
